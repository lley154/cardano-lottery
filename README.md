...
- [Tips & Tricks](#tips--tricks)
  - [How To Run cardano-cli When The Cardano Node Is Running On A Different Server](#how-to-run-cardano-cli-when-the-cardano-node-is-running-on-a-different-server)
  - [How To Create A Verification, Signing Key, Public Key Hash and Address](#how-to-create-a-verification-signing-key-public-key-hash-and-address)
  - [How To Determine Your Unspent UTXO](#how-to-determine-your-unspent-utxo)
  - [How To See the UTXOs At A Script Address](#how-to-see-the-utxos-at-a-script-address)
  - [How To Transfer ADA To Your Wallet To Setup Collateral UTXO](#how-to-transfer-ada-to-your-wallet-to-setup-collateral-utxo)
  - [How To Use The Local Devnet](#how-to-use-the-local-devnet)
  - [Devnet Blockchain TX Monitoring](#devnet-blockchain-tx-monitoring)
  - [How To Change The Lotto Ticket Cost Or Admin Public Key Hash](#how-to-change-the-lotto-ticket-cost-or-admin-public-key-hash)
  - [How To Undo A Devnet Lotto State Machine Step](#how-to-undo-a-devnet-lotto-state-machine-step)  
